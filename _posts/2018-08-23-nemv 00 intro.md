...
처음에는 좀 당황했지만, 결국 새 프로젝트 시작하기가 훨씬 수월해 졌습니다.

"복잡한 설정은 전문가나 줘버리자"가 뷰컴 개발진에서 설명하려 하는 것 같아보입니다.

이제 웹팩 같은 건 시스템에 완전 녹여버려서 신경 쓸 필요가 없게 되었습니다.
...
어떤 플랫폼을 꼭 써야할 필요는 없습니다. 그저 지금 시대에는 대세를 따라가는 것이 좋습니다.
...
> 밑의 Note는 현재는 개발용도 서버지만 yarn run build를 하면 진짜서버에서 돌아가도록 압축 해준다는 것입니다.
...
아톰 설치 후에 vue 플러그인 깔아주면 뷰 코드 수정이 좋아지겠죠..?
...
생산적인 고민을 해야 할 위치는 뻔해 왠지 감이 옵니다.
